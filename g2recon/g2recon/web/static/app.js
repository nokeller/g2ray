...
function runModal(){
  ...
  const fromY=el("input",{type:"number",value:2015,style:"width:90px"});
    ...
    el("div",{class:"row spread",style:"margin-top:14px"},
      ...
      el("button",{class:"btn primary",onclick:async()=>{
        ...
        const opt={ excluded_steps:excluded, subdomain_sources:sources,
          ...
          wayback_from_year:+fromY.value||2015, wayback_to_year:+toY.value||0,
...
async function settingsModal(){
  ...
  const warp=el("input",{value:s.warp_command||"",style:"width:100%",placeholder:"optional IP-rotation command e.g. warp-cli disconnect && warp-cli connect"});
  ...
  const card=el("div",{class:"card"}, el("h3",{},"Settings"), banner,
    ...
    el("div",{class:"field"},el("label",{},"WARP / VPN rotation command"),warp),
    el("div",{class:"row wrap",style:"gap:14px"},
    ...
    el("div",{class:"row spread",style:"margin-top:12px"}, el("button",{class:"btn",onclick:closeModal},"Close"),
      el("button",{class:"btn primary",onclick:async()=>{
        const body={ warp_command:warp.value, download_workers:+dlw.value, check_workers:+chw.value,
