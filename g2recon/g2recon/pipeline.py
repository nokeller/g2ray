        ...
        for u in juicy:
            ...
            if "live" in variants:
                items.append({"url": u, "variant": "live", "parent_url": util.host_of(u),
                              "kind": kind, "depth": 0})
            if "archived" in variants and ts_map.get(u):
                items.append({"url": u, "variant": "archived", "archive_ts": ts_map[u],
